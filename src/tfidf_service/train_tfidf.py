...
def main():
    ...
    with mlflow.start_run(run_name="tfidf_svm_training") as run:
        ...
        fitted_base_pipeline, trained_pipeline, metrics, class_report, conf_matrix = train_and_evaluate(
        ...
        save_model_and_metrics(
            fitted_base_pipeline, trained_pipeline, metrics, class_report, 
            conf_matrix, label_encoder, params
        )
