...
def load_params():
    ...
    return params["tfidf_train_optimized"]
...
def save_model_and_metrics(
    ...
    with open("metrics/tfidf_metrics_enhanced.json", "w") as f:
        json.dump(full_metrics, f, indent=2)

    print(" Modèle sauvegardé dans models/tfidf_model.pkl")
    print(" Vectorizer sauvegardé dans models/tfidf_vectorizer.pkl")
    print(" Métriques sauvegardées dans metrics/tfidf_metrics_enhanced.json")
...
def main():
    ...
    with mlflow.start_run(run_name="tfidf_svm_training") as run:
        ...
        mlflow.log_param("model_type", "TF-IDF + SVM Optimized")
        ...
        mlflow.sklearn.log_model(
            trained_pipeline,
            "tfidf_svm_model",
            registered_model_name="callcenter_tfidf_model_optimized",
        )
