...
class TFIDFModelLoader:
    ...
    def __init__(
        ...
        self.model_path = Path(model_path) if model_path else base_path / "../../../models/tfidf_model.pkl"
        self.encoder_path = Path(encoder_path) if encoder_path else base_path / "../../../data/processed/label_encoder.pkl"
        self.model = None
